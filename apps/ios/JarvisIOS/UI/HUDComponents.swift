    ...
    GeometryReader { geometry in
      ZStack {
        ...
        Path { path in
          ...
          for xOffset in stride(from: 0, through: geometry.size.width, by: spacing) {
            path.move(to: CGPoint(x: xOffset, y: 0))
            path.addLine(to: CGPoint(x: xOffset, y: geometry.size.height))
          }

          for yOffset in stride(from: 0, through: geometry.size.height, by: spacing) {
          ...
          .stroke(
            AngularGradient(
              colors: [
                ...
                .clear,  // swiftlint:disable:this trailing_comma
              ],
              center: .center
            ),
        ...
        .fill(
          RadialGradient(
            colors: [
              ...
              JarvisTheme.backgroundBottom,  // swiftlint:disable:this trailing_comma
            ],
            center: .center,
            startRadius: 8,
            endRadius: 88
